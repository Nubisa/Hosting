    ...
    public function formAction()
    {
        ...
        */
                ...
                $form->addElement('checkbox', 'exampleCheckbox', array(
                    'label' => 'JXcore enabled',
                    'value' => pm_Settings::get('exampleCheckbox'),
                ));


        $form->addElement('hidden', 'exampleText1', array(
        ...
        if ($this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost())) {
                       ...
                       // $this->view->osiem1 =  $form->getValue('exampleText');
            ...
            $this->_helper->json(array('redirect' => pm_Context::getBaseUrl()));
                        ...
                        //$this->getRequest().getPost("exampleText1");
        }
